...
from modules.custom_procedure_base import CustomProcedureBase
...
from modules.v_nas import LINE_STYLE_NONE, LINE_STYLE_SOLID, LINE_STYLES

ERROR_HEADER = "STARS Custom Procedure: "


class STARSCustomProcedure(CustomProcedureBase):
    line_type: str
    x_offset: float
    y_offset: float
    symbol_scale: float
    ...
    def __init__(self, definition_dict: dict[str, object]):
        super().__init__(definition_dict)
        self.line_type = ""
        self.x_offset = 0.0
        self.y_offset = 0.0
