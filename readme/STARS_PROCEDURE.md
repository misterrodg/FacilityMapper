...
| `draw_symbols`         |          | `bool`   | `false`                               | A boolean value that tells the script to draw a symbol at the fix location. The symbol type is driven by the fix data.                                               |
...
| `use_faf_symbol`       |          | `bool`   | `false`                               | IAP only: A bool value that tells the script to draw the FAF with the FAF symbol.                                                                                    |
