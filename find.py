...
if os.path.exists(DB_FILE_PATH):
    ...
    if controlled:
        ...
        query = f"SELECT DISTINCT center_id, airspace_class FROM controlled_points WHERE (lat BETWEEN {min_lat} AND {max_lat} AND lon BETWEEN {min_lon} AND {max_lon}) OR (arc_lat BETWEEN {min_lat} AND {max_lat} AND arc_lon BETWEEN {min_lon} AND {max_lon});"
    ...
    if restrictive:
        ...
        query = f"SELECT DISTINCT restrictive_id, restrictive_type FROM restrictive_points WHERE (lat BETWEEN {min_lat} AND {max_lat} AND lon BETWEEN {min_lon} AND {max_lon}) OR (arc_lat BETWEEN {min_lat} AND {max_lat} AND arc_lon BETWEEN {min_lon} AND {max_lon});"
